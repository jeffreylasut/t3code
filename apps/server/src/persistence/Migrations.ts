...
import Migration0048 from "./Migrations/048_ProviderRateLimitSnapshots.ts";
import Migration0049 from "./Migrations/049_ProjectionThreadsContextWindow.ts";
...
export const migrationEntries = [
  ...
  [48, "ProviderRateLimitSnapshots", Migration0048],
  [49, "ProjectionThreadsContextWindow", Migration0049],
] as const;
